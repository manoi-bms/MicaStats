...
เมื่อเลือกแถว จะมีแผงด้านล่างรายการแสดงพาธเต็ม คำสั่งที่ใช้เรียก บัญชีผู้ใช้ และสถานะการยกระดับสิทธิ์ของโปรเซสนั้น ข้อมูลเหล่านี้ต้องเปิดโปรเซสเพื่ออ่าน จึงอ่านเฉพาะแถวที่เลือกเท่านั้น ในเบื้องหลัง และไม่อ่านสำหรับทั้งรายการ ส่วนแถบด้านล่างแสดงต้นทุนรวมของทุกโปรเซสที่ตรงกับคำค้น ทั้งจำนวน CPU หน่วยความจำ และดิสก์ บนเครื่องที่มีโปรเซสราว 1,300 ตัว ความต่างตรงนี้คือหัวใจของฟีเจอร์
